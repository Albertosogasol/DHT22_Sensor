...
miWriteAPIKey_conjunta = "YourAPIKey"
#Ubidots Token
TOKEN="YourToken"
...
def main():
   ...
   baseURL_conjunta = 'https://api.thingspeak.com/update?api_key=%s' % miWriteAPIKey_conjunta
   while True:
       try:     
           ...
           f_ext.close()
           #Lectura sensores exterior e interior (conjunta)
           #f_conjunta = urlopen(baseURL_conjunta + "&field1=%s&field2=%s" % (RH_ext, T_ext, RH_int, T_int))
           #f_conjunta.close()
           #Lectura UbiDots
